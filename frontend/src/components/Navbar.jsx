...
const navigate = useNavigate();
  ...
  return (
    <>
      <div className="px-5 sticky top-0 z-50 py-[.8rem] lg:px-20 flex bg-[#d3c81f] justify-between">
       <Link to='/'>
        ...
        <div className="flex items-center space-x-2 1g:space-x-10">
          ...
          <div onClick={() => navigate('/account/users/login')} className="flex mx-6 cursor-pointer">
            <div>

            {false ? <Avatar sx={{ bgcolor: "white", color: green.A100 }}>S</Avatar> : 
            <IconButton >
              <PersonIcon/>
            </IconButton>
            }
